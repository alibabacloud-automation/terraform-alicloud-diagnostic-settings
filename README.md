...
This Terraform module provides diagnostic logging and monitoring capabilities on Alibaba Cloud, similar to [Azure Diagnostic Settings](https://github.com/claranet/terraform-azurerm-diagnostic-settings). It leverages [ActionTrail](https://www.alibabacloud.com/help/en/actiontrail/) for API audit logging and [SLS (Simple Log Service)](https://www.alibabacloud.com/help/en/sls/) for comprehensive log collection and analysis.
